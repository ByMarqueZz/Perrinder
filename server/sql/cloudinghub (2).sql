...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2023 a las 20:39:00
...
INSERT INTO `ftp` (`id`, `idUser`, `username`, `password`, `path`) VALUES
(1, 1, 'root', 'TaliA2014.A', 'C:/xampp/htdocs'),
(6, 6, 'beta', 'db92d9eb8e34', 'C:/xampp/htdocs/beta'),
(7, 7, 'javs', 'beaac2f588be', 'C:/xampp/htdocs/javs');
...
(5, 7, 'price_1NfOV2BfMzihRfkFNNgZGrsw', 1, '2023-08-31 19:39:03', '2023-09-05 01:04:08');
...
(76, 1, 89, 'C:/xampp/htdocs/jointscounter', 'JointsCounter', 'jointscounter.com', 1, '2023-11-02 20:37:20', '2023-11-02 20:37:20'),
...
--
-- Filtros para la tabla `ftp`
--
ALTER TABLE `ftp`
  ADD CONSTRAINT `ftp_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `user` (`id`);
